...
author:
  - name:
    ...
    roles: ["analysis", "investigation", "methodology", "software", "visualization", "validation", "writing"]
    corresponding: true
    affiliation:
      - ref: a
  - name:
...
significance: |
  The human brain is thought to encode sensory information in population activity patterns but the structure of such codes has yet to be characterized. By examining large-scale neuroimaging recordings of human vision using a spectral approach more common in physics than neuroscience, we reveal a universal scale-free structure of population codes in visual cortex. It is found in all subjects and at multiple stages of visual processing. Moreover, despite differences in learning experience or brain anatomy, this code is shared across individuals over a wide range of latent dimensions, indicating a strong convergence toward a common high-dimensional representation of visual scenes. This work reveals a vast space of uncharted neural dimensions that have been out of reach of conventional analysis techniques.
authorship-contribution: |
  CRediT authorship statement: RMG: Formal analysis, Investigation, Methodology, Software, Validation, Visualization, Writing~\textendash~original draft; BM: Conceptualization, Methodology, Supervision, Writing~\textendash~review \& editing, Funding acquisition; MFB: Conceptualization, Methodology, Supervision, Writing~\textendash~review \& editing, Project administration, Funding acquisition
...
When the train and test samples are drawn from the same distribution, the covariance matrix $\Sigma$ is diagonal in expectation. In practice,  under normal circumstances, $\Sigma$ is quasi-diagonal and we have verified that the contribution from off-diagonal terms is negligible. We thus estimate the cross-validated spectrum as
...
The dataset analysed in this study is the publicly available Natural Scenes Dataset [@Allen2021].
