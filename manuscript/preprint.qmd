...
This research was supported in part by a Johns Hopkins Catalyst Award to MFB, Institute for Data Intensive Engineering and Science Seed Funding to MFB and BM, and grant NSF PHY-2309135 to the Kavli Institute for Theoretical Physics. The authors would like to thank Leyla Isik, Daeyeol Lee, Nikolaus Kriegeskorte, and Kelsey Han for their valuable comments on the manuscript.
